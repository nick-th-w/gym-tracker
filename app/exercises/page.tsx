...
export default async function ExercisesPage({
  ...
  // All three run in parallel: exercise list (1hr cache), favourites, completion counts (5min cache)
  const [exercises, { data: favRows }, completionCount] = await Promise.all([
    getCachedExercises(),
    user
