  ...
  if (!lastWorkout) {
    return (
      <div className="flex flex-col px-4 pt-5 pb-6 gap-3">
        ...
        <Link href="/workout"
          className="cta-pulse mt-3 w-full bg-success hover:opacity-90 active:scale-95 text-white font-bold py-8 rounded-2xl text-3xl transition-all duration-150 flex items-center justify-center gap-3">
