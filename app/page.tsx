export default function TodayPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-5rem)] px-6 text-center">
      ...
      <button className="w-full max-w-sm bg-success hover:opacity-90 active:scale-95 text-white font-semibold py-4 rounded-2xl text-lg transition-all duration-150">
        Start Workout
      </button>
    </div>
  )
